...
public class PlacesActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder = new Geocoder(PlacesActivity.this);
    ...
    private void moveCamera(LatLng latLng, float zoom ,String title){
       ...
       mMap.addMarker(options);
        ...
        String mID = mApp.getMeetupToBeSaved();
        final DatabaseReference myRef = FirebaseDatabase.getInstance().getReference().child("meetups").child(mID);
        mMap.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker marker) {
                ...
                myRef.child("coordinates").setValue(marker.getPosition());
            }
        });
